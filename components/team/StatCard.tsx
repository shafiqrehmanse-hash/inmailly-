...
export default function StatCard({ value, label, sub, className }: StatCardProps) {
  return (
    <div className={cn("lux-card p-5 text-center hover:border-[rgba(229,25,55,0.25)] transition-all", className)}>
      <div className="font-bricolage font-extrabold text-2xl team-stat-value tabular-nums">{value}</div>
